class QuantumCohomologyPartialFlagVariety:
    def __init__(self, dynkin, parabolic, base=QQ):
        ...
        # TODO checks on parabolic
        # TOD make parabolic ordered and non-repetitive
        ...
        self.divisors = [self.module.basis()[self.weyl_group.gen(k-1)] for k in self.parabolic]
    ...
    def quantum_chevalley(self, divisor, element):
        ...
        J. Algebraic Geom. 13 (2004), no. 4, 641–661.
